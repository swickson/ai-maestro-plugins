...
Build your own Claude Code plugin by composing skills, scripts, and hooks from multiple sources.

This isn't a static plugin you install as-is. It's a **composable build system**. Fork this repo, edit `plugin.manifest.json` to pick the sources you want, and the builder assembles a custom plugin tailored to your workflow. Add skills from any GitHub repo, remove what you don't need, mix in your own — then CI builds and commits the result automatically.
